...
public class CartItemController {
    ...
    public ResponseEntity<CartItem> createCartItem(@RequestBody CartItem cartItem) throws IdInvalidException {
    ...
    public ResponseEntity<ResultPaginationDTO> getAllCartItems(
        ...
        ResultPaginationDTO result = cartItemService.getAllCartItems(spec, pageable);
